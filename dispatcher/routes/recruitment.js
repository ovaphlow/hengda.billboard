...
router
  .get('/', async (ctx) => {
    const grpcFetch = () => new Promise((resolve, reject) => grpcClient.list({ data: JSON.stringify({}) }, (err, response) => {
      if (err) {
        console.error(err);
        reject(err);
      } else {
  ...
  .get('/subject/:subject', async (ctx) => {
    const grpcFetch = (body) => new Promise((resolve, reject) => grpcClient.subject(body, (err, response) => {
      if (err) {
        console.error(err);
        reject(err);
      } else {
  ...
  .put('/keyword-search/', async (ctx) => {
    const grpcFetch = (body) => new Promise((resolve, reject) => grpcClient.keywordSearch(body, (err, response) => {
      if (err) {
        console.error(err);
        reject(err);
      } else {
...
router.get('/enterprise/:id/', async (ctx) => {
  const grpcFetch = (body) => new Promise((resolve, reject) => grpcClient.enterpriseList(body, (err, response) => {
    if (err) {
      console.error(err);
      reject(err);
    } else {
  ...
  const grpcFetch = (body) => new Promise((resolve, reject) => grpcClient.enterpriseSearch(body, (err, response) => {
    if (err) {
      console.error(err);
      reject(err);
    } else {
