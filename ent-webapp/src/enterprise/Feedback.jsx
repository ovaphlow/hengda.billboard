          ...
          <div className="card-body">
            ...
            <div className="row">
              <div className="col">
                <div className="form-group">
                  <label>类别</label>
                  <select type="text" id="category" className="form-control">
                    <option>意见反馈</option>
            ...
            <div className="row">
              <div className="col">
                <div className="form-group">
                  <label>说明</label>
                  <textarea id="content" cols={4} className="form-control" />
                </div>
              </div>
            </div>
            <div className="row">
              <div className="col">
                <button className="btn btn-primary pull-right" type="button" onClick={handleSave}>
                  提交
                </button>
              </div>
            </div>
