...
router
  ...
  .put('/phone', async (ctx) => {
    const grpcFetch = (body) => new Promise((resolve, reject) => grpcClient.phone(body, (err, response) => {
      if (err) {
        console.error(err);
        reject(err);
      } else {
  ...
  .get('/journal/:user_id/', async (ctx) => {
    const grpcFetch = (body) => new Promise((resolve, reject) => grpcClient.journal(body, (err, response) => {
      if (err) {
        console.error(err);
        reject(err);
      } else {
