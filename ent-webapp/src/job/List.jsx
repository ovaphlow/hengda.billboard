    ...
    <View category="我的职位">
      <div className="row px-5 pt-2 bg-white shadow">
        ...
        <div className="col">
          ...
          &nbsp;&nbsp;
          <button onClick={search} className="btn btn-success rounded-0" type="button">
            报名
          </button>
        </div>
      </div>
      ...
      <div className="row mt-3 bg-white shadow">
        <div className="col card rounded-0">
          <div className="card-body">
            ...
            <a className="pull-right btn btn-link btn-lg" href="#招聘会/新增">
                      ...
                      <td>
                        <div className="btn-group btn-group-sm">
                          <a
                            ...
                            href={`#招聘会/编辑/${item.id}?u_id=${item.uuid}`}
                          >
                            详情
                          </a>
                        </div>
