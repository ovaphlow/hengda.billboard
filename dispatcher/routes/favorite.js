...
router
  ...
  .put('/search/resume/', async (ctx) => {
    const grpcFetch = (body) => new Promise((resolve, reject) => grpcClient.searchResume(body, (err, response) => {
      if (err) {
        console.error(err);
        reject(err);
      } else {
  ...
  .put('/search/one/', async (ctx) => {
    const grpcFetch = (body) => new Promise((resolve, reject) => grpcClient.searchOne(body, (err, response) => {
      if (err) {
        console.error(err);
        reject(err);
      } else {
